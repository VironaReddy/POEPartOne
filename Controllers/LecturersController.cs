...
namespace POEOne.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(POEOneContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LecturerID,LecturerName,LecturerEmail,HoursTaught,Rate,Month")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LecturerID,LecturerName,LecturerEmail,HoursTaught,Rate,Month")] Lecturer lecturer)
        {
